...
def main() -> None:
    ...
    print(
        "Case 1: Singleton classes are initialized once and different class hierarchies are not mixed"
    )
    ...
    print(
        "Case 2: Singleton decorator allow to pass arguments to the class constructor"
    )
    ...
    print(
        "Case 3: Singleton-decorated classes preserve their original metadata thanks to wraps"
    )
